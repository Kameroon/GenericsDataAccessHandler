...
namespace DataAccessHandler
{
    public class DBManager
    {
        ...
        {
            return DataParameterManager.CreateParameter(providerName, 
                name, 
                value, 
                dbType, 
        ...
        public long Insert(string commandText, 
            CommandType commandType, 
            IDbDataParameter[] parameters,
            out long lastId)
        {
        ...
        public void InsertWithTransaction(string commandText,
            CommandType commandType, 
            IDbDataParameter[] parameters)
        {
        ...
        public void UpdateWithTransaction(string commandText,
            CommandType commandType, 
            IDbDataParameter[] parameters)
        {
            IDbTransaction transactionScope = null;
