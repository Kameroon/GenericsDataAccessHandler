...
namespace DataAccessHandler
{
    ...
    {
        public static void SqlBulkCopy(SqlConnection connection,
            DataTable table, 
            string destinationTable)
        {
            ...
            try
            {
                ...
                {
                    sqlBulkCopy.ColumnMappings.Add(column.ColumnName,
                        column.ColumnName);
        ...
        public static void SqlBulkCopy<T>(SqlConnection connection,
